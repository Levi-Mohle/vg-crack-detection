...
python src/train.py experiment=impasto_FM2 trainer=ddp trainer.devices=2 data.variant=Enc_512x512 model.FM_param.plot=false model.FM_param.ood=false model.DDPM_param.plot_n_epoch = 20